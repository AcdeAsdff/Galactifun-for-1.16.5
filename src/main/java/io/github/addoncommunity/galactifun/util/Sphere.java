...
public final class Sphere {
    ...
    public void generate(@Nonnull Location middle, @Nonnull Chunk region, int min, int dev) {
...
//        this.currentMiddle = null;
    ...
    private void gen(int x, int y, int z) {
        ...
        this.currentRegion.getBlock(
                currentMiddle.clone().add(x, y, z).getBlockX(),
                currentMiddle.clone().add(x, y, z).getBlockY(),
                currentMiddle.clone().add(x, y, z).getBlockZ()
        ).setType(
                this.materials[this.currentMaterial++]
        );
    }
