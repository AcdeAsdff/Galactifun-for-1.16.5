 ...
 */
public class Paper1181SimplexOctaveGenerator extends Paper1181OctaveGenerator {
     ...
     */
    public Paper1181SimplexOctaveGenerator(@NotNull World world, int octaves) {
     ...
     * @param octaves Amount of octaves to create
     */
    public Paper1181SimplexOctaveGenerator(long seed, int octaves) {
     ...
     * @param octaves Amount of octaves to create
     */
    public Paper1181SimplexOctaveGenerator(@NotNull Random rand, int octaves) {
    ...
    public double noise(double x, double y, double z, double w, double frequency, double amplitude, boolean normalized) {
        ...
        for (Paper1181NoiseGenerator octave : octaves) {
            result += ((Paper1181SimplexNoiseGenerator) octave).noise(x * freq, y * freq, z * freq, w * freq) * amp;
            max += amp;
            freq *= frequency;
            amp *= amplitude;
        }
    ...
    private static Paper1181NoiseGenerator[] createOctaves(@NotNull Random rand, int octaves) {
        ...
        for (int i = 0; i < octaves; i++) {
            result[i] = new Paper1181SimplexNoiseGenerator(rand);
        }
