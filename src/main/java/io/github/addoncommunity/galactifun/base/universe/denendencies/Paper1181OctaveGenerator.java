 ...
 */
public abstract class Paper1181OctaveGenerator {
    @NotNull
    protected final Paper1181NoiseGenerator[] octaves;
    protected double xScale = 1;
    protected double yScale = 1;
    protected double zScale = 1;

    protected Paper1181OctaveGenerator(@NotNull Paper1181NoiseGenerator[] octaves) {
     ...
     */
    @NotNull
    public Paper1181NoiseGenerator[] getOctaves() {
    ...
    public double noise(double x, double y, double frequency, double amplitude, boolean normalized) {
        return noise(x, 0, y, frequency, amplitude, normalized);
    }
