...
public final class BaseUniverse {
    ...
    public static final PlanetaryObject JUPITER = new PlanetaryObject(
            "&6Jupiter",
            PlanetaryType.getById("GAS_GIANT"),
    ...
    public static final AlienWorld IO = new Io(
            "&6Io",
            PlanetaryType.getById("TERRESTRIAL"),
...
//        AlienWorldList.put("Venus", VENUS);
////        AlienWorldList.put("Jupiter",JUPITER);
//        AlienWorldList.put("Io",IO);
//        AlienWorldList.put("Europa",EUROPA);
////        AlienWorldList.put("Earth",EARTH);
//        AlienWorldList.put("Earth Orbit",EARTH_ORBIT);
//        AlienWorldList.put("Encaladus",ENCALADUS);
//        AlienWorldList.put("Titan",TITAN);
//        AlienWorldList.put("Mars",MARS);
//        AlienWorldList.put("The Moon",THE_MOON);
