...
import static io.github.addoncommunity.galactifun.base.BaseItems.BROKEN_SOLAR_PANEL_RELIC;
import static io.github.addoncommunity.galactifun.base.BaseItems.FALLEN_SATELLITE_RELIC;
...
public final class BaseMats {
    ...
    public static final SlimefunItemStack LASERITE_DUST = new SlimefunItemStack(
            ...
            Bukkit.getPluginManager().isPluginEnabled("SlimefunWarfare") ?
                    "&7可以用Slimefun Warfare的Laser Doide(激光二极管)替换" :
                    ""
    );
...
//        worldItem(FALLEN_SATELLITE_RELIC,
//                BaseUniverse.THE_MOON,
//                BaseUniverse.MARS,
//                BaseUniverse.TITAN,
//                BaseUniverse.VENUS,
//                BaseUniverse.IO,
//                BaseUniverse.ENCALADUS
//        );
//        worldItem(BROKEN_SOLAR_PANEL_RELIC,
//                BaseUniverse.THE_MOON,
//                BaseUniverse.MARS,
//                BaseUniverse.TITAN,
//                BaseUniverse.VENUS,
...
//        );
        ...
        component(MUNPOWDER, CoreRecipeType.ALIEN_DROP,
                null, null, null,
                null, new CustomItemStack(Material.CREEPER_HEAD, "&f变异爬行者")
        );
...
//        try{
//            AlienWorld[] mappingWorlds = Galactifun.worldManager().alienWorlds().stream()
//                    .filter(a -> a.getSetting("generate-fallen-satellites", Boolean.class, true))
//                    .toArray(AlienWorld[]::new);
//
//            for (AlienWorld i_ : mappingWorlds) {
//                i_.addBlockMapping(BROKEN_SOLAR_PANEL_RELIC.getType(), BROKEN_SOLAR_PANEL_RELIC);
//                i_.addBlockMapping(FALLEN_SATELLITE_RELIC.getType(), FALLEN_SATELLITE_RELIC);
//            }
//        }catch (Exception e){e.printStackTrace();};
    ...
    private static void worldItem(SlimefunItemStack item, AlienWorld... worlds) {
        ...
        for (int i = 0; i < worlds.length; i++) {
            ...
            world.addBlockMapping(BROKEN_SOLAR_PANEL_RELIC.getType(), BROKEN_SOLAR_PANEL_RELIC);
            world.addBlockMapping(FALLEN_SATELLITE_RELIC.getType(), FALLEN_SATELLITE_RELIC);
        }
